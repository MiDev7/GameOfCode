const quiz_data = [
  ...
  {
    question:
      "Modular programming is a technique where a program is divided into smaller, self-contained units called modules, which can be developed and tested independently.",
    options: ["true", "false"],
    correct: "true",
  },
  {
  ...
  {
    question:
      "Which principle is crucial for organizing and managing collections of data in complex programs?",
    options: [
